# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.6 on Wed Aug 12 19:09:30 2020
#
...
class Ventana(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.radioTypeA = wx.RadioButton(self.panel_1, wx.ID_ANY, "Tipo A", style=wx.RB_GROUP)
        self.radioTypeB = wx.RadioButton(self.panel_1, wx.ID_ANY, "Tipo B")
        self.radioTypeC = wx.RadioButton(self.panel_1, wx.ID_ANY, "Tipo C")
        ...
        self.buttonGenerate = wx.Button(self.panel_1, wx.ID_ANY, u"¡Generar!")
        ...
        self.labelVelocidad = wx.StaticText(self.panel_2, wx.ID_ANY, "Velocidad")
        self.spinFps = wx.SpinCtrlDouble(self.panel_2, wx.ID_ANY, "24.0", min=0.1, max=100.0)
        self.labelFPS = wx.StaticText(self.panel_2, wx.ID_ANY, "FPS")
        self.buttonSave = wx.Button(self.panel_2, wx.ID_ANY, "Guardar")
    ...
    def __do_layout(self):
        ...
        sizerResultado = wx.StaticBoxSizer(wx.StaticBox(self.panel_2, wx.ID_ANY, "Resultado"), wx.VERTICAL)
        sizer_4 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_5 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_6 = wx.StaticBoxSizer(wx.StaticBox(self.panel_1, wx.ID_ANY, u"Parámetros"), wx.VERTICAL)
        grid_sizer_1 = wx.FlexGridSizer(5, 2, 2, 2)
        sizer_8 = wx.BoxSizer(wx.HORIZONTAL)
        sizer_2 = wx.BoxSizer(wx.HORIZONTAL)
        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Tamaño")
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_2.Add(self.spinWidth, 0, 0, 0)
        label_7 = wx.StaticText(self.panel_1, wx.ID_ANY, " x ")
        sizer_2.Add(label_7, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_2.Add(self.spinHeight, 0, 0, 0)
        label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, " pixels")
        ...
        label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, "Gradiente")
        grid_sizer_1.Add(label_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.gradientWidget, 1, wx.EXPAND, 0)
        label_3 = wx.StaticText(self.panel_1, wx.ID_ANY, "Tipo")
        ...
        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Imágenes")
        grid_sizer_1.Add(label_5, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.spinNumFrames, 0, 0, 0)
        label_6 = wx.StaticText(self.panel_1, wx.ID_ANY, "Granulado")
